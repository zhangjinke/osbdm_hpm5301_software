...
const byte NVOPT_INIT  = 0x02; // vector redirect, flash unsecure
const byte NVPROT_INIT = 0xFA; // 0xFC00-0xFFFF are protected
...
// void (*volatile const _UserEntry[])() = {0x9DCC, // asm NOP(9D), asm JMP(CC)
//                                          _Startup};

// // redirect vector 0xFFC0-0xFFFD to 0xFBC0-0xFBFD
// void (*volatile const _Usr_Vector[])() = {
