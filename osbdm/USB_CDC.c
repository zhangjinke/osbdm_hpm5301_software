...
void CDC_Engine (void)
{
  ...
  if ((sci_virtual_serial_port_is_enabled) && (Bdtmap.ep3Bio.Stat.McuCtlBit.OWN == 0) // Data Available from PC
  )
  {
  ...
  if ((sci_virtual_serial_port_is_enabled) && (Bdtmap.ep4Bio.Stat.McuCtlBit.OWN == 0) && // Is USB transmit empty AND
