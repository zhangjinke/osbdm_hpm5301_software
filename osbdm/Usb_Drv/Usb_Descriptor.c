...
const UINT8 Device_Dsc_No_Serial_Number[Device_Descriptor_Size] = {
  ...
  0x01, // bDescriptor
  0x00,
  0x02,          // bcdUSB ver R=2.00
  0xEF,          // bDeviceClass
  0x02,          // bDeviceSubClass
  0x01,          // bDeviceProtocol
  EP0_BUFF_SIZE, // bMaxPacketSize0
  0xA2,
  0x15, // idVendor - 0x15A2(freescale Vendor ID)
  0x5E,
  0x00, // idProduct
  0x00,
...
const UINT8 Cfg_01[Device_Configuration_Size] = {
  ...
  0x10,
  0x01, // bcdCDC - Revision of USB CDC Spec
...
const UINT8 Device_Qualifier[10] = {
  ...
  0x00,
  0x02, // bcdUSB - USB Spec Rev: V2.00
  0x00, // bDeviceClass
...
struct
{
  ...
  byte bDscType;
  byte string[54];
} const sd001 = {sizeof(sd001), DSC_STR, {'F', 0, 'r', 0, 'e', 0, 'e', 0, 's', 0, 'c', 0, 'a', 0, 'l', 0, 'e', 0,
                                          ' ', 0, 'S', 0, 'e', 0, 'm', 0, 'i', 0, 'c', 0, 'o', 0, 'n', 0, 'd', 0,
                                          'u', 0, 'c', 0, 't', 0, 'o', 0, 'r', 0, ' ', 0, 'I', 0, 'n', 0, 'c', 0}};


OSSerialNum_t OSSerialNum = {sizeof(OSSerialNum),
                             DSC_STR,
                             {
                               'O',
                               0,
...
volatile byte _Serial3;
volatile byte _Serial2;
volatile byte _Serial1;
volatile byte _Serial0;
...
struct
{
  ...
  byte bDscType;
  byte string[36];
} const sd002 = {sizeof(sd002),
                 DSC_STR,
                 {
                   'O', 0, 'S', 0, 'B', 0, 'D', 0, 'M', 0, ' ', 0, '-', 0, ' ', 0, 'D', 0,
                   'e', 0, 'b', 0, 'u', 0, 'g', 0, ' ', 0, 'P', 0, 'o', 0, 'r', 0, 't', 0,
                 }};
...
struct
{
  ...
  byte bDscType;
  byte string[46];
} const sd003 = {sizeof(sd003),
                 DSC_STR,
                 {
                   'O', 0, 'S', 0, 'B', 0, 'D', 0, 'M', 0, ' ', 0, '-', 0, ' ', 0, 'C', 0, 'D', 0, 'C', 0, ' ', 0,
                   'S', 0, 'e', 0, 'r', 0, 'i', 0, 'a', 0, 'l', 0, ' ', 0, 'P', 0, 'o', 0, 'r', 0, 't', 0,
                 }};


unsigned char *Str_Des[] = {(unsigned char *)&sd000,
                            (unsigned char *)&sd001,
                            (unsigned char *)&sd002,
                            (unsigned char *)&sd003,
                            (unsigned char *)&OSSerialNum};

unsigned char *Cfg_Des[] = {(unsigned char *)&Cfg_01, (unsigned char *)&Cfg_01};
